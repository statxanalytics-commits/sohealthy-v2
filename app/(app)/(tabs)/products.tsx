...
const s = StyleSheet.create({
  ...
  heroCard: { backgroundColor: Colors.pine, borderRadius: 16, padding: 20, flexDirection: 'row', alignItems: 'center', marginBottom: 12 },
  ...
  reminderBox: { backgroundColor: Colors.pine + '10', borderRadius: 12, padding: 14, alignItems: 'center', marginTop: 16, marginBottom: 12 },
  ...
  changeBtn: { borderWidth: 1.5, borderColor: Colors.pine + '30', borderRadius: 10, padding: 12, alignItems: 'center' },
  changeBtnText: { color: Colors.pine, fontWeight: '600', fontSize: 13 },
  btnRow: { flexDirection: 'row', gap: 10 },
  btnFlex: { flex: 1 },
  detailBtnP: { backgroundColor: Colors.pine, borderRadius: 10, padding: 12, alignItems: 'center' },
  detailBtnPText: { color: '#fff', fontWeight: '700', fontSize: 13 },
  noProductCard: { backgroundColor: '#fff', borderRadius: 16, padding: 24, alignItems: 'center', marginBottom: 12 },
  ...
  weightCard: { backgroundColor: '#fff', borderRadius: 14, padding: 16, marginBottom: 12, shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 6, elevation: 1 },
  ...
  weightLossStat: { backgroundColor: Colors.aloe + '15', borderRadius: 10, padding: 8 },
  weightStatLbl: { fontSize: 11, color: '#888', marginBottom: 4 },
  weightStatVal: { fontSize: 18, fontWeight: '700', color: Colors.pine },
  addWeightBtn: { backgroundColor: Colors.aloe + '20', borderRadius: 10, padding: 12, alignItems: 'center' },
  addWeightText: { color: Colors.pine, fontWeight: '600', fontSize: 13 },
  newCodeSection: { backgroundColor: Colors.pine + '08', borderRadius: 14, padding: 16, marginBottom: 10, borderWidth: 1, borderColor: Colors.pine + '15' },
  ...
  newCodeBtn: { backgroundColor: Colors.pine, borderRadius: 10, padding: 14, alignItems: 'center' },
  newCodeBtnText: { color: '#fff', fontWeight: '700', fontSize: 14 },
  historyBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, borderWidth: 1.5, borderColor: Colors.pine + '30', borderRadius: 10, padding: 14, marginBottom: 8 },
