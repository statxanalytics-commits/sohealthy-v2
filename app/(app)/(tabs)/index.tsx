          ...
          <>
            ...
            <View style={s.premiumRow}>
              {PREMIUM_TOOLS.map(tool => {
                const Icon = tool.Icon
                return (
                  <TouchableOpacity key={tool.id} style={s.premiumSmall} onPress={() => handlePremiumTool(tool)}>
...
const s = StyleSheet.create({
  ...
  avatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: Colors.aloe, alignItems: 'center', justifyContent: 'center' },
  ...
  countdownPill: { alignSelf: 'flex-start', backgroundColor: 'rgba(113,181,162,0.25)', borderRadius: 20, paddingHorizontal: 10, paddingVertical: 3, marginTop: 8 },
  countdownPillUrgent: { backgroundColor: 'rgba(183,73,73,0.9)' },
  countdownText: { fontSize: 11, fontWeight: '700', color: Colors.alabaster, letterSpacing: 0.3 },
  countdownTextUrgent: { color: '#fff' },
  countdownBanner: { backgroundColor: Colors.pine, marginHorizontal: 16, marginTop: 12, borderRadius: 16, padding: 16 },
  quizCard: { marginHorizontal: 16, marginTop: 12, backgroundColor: '#fff', borderRadius: 16, padding: 16, flexDirection: 'row', alignItems: 'center', borderWidth: 1.5, borderColor: Colors.aloe },
  quizCardIcon: { width: 44, height: 44, borderRadius: 12, backgroundColor: 'rgba(113,181,162,0.15)', alignItems: 'center', justifyContent: 'center', marginRight: 14 },
  quizCardLeft: { flex: 1, marginRight: 10 },
  quizCardBadge: { alignSelf: 'flex-start', fontSize: 9, letterSpacing: 2, fontWeight: '700', color: Colors.aloe, marginBottom: 4 },
  ...
  bookCard: { backgroundColor: Colors.aloe, marginHorizontal: 16, marginTop: 10, borderRadius: 14, padding: 16, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  bookCardLeft: { flex: 1 },
  ...
  sectionLabel: { fontSize: 10, letterSpacing: 2, color: '#6B7F72', fontWeight: '600', marginHorizontal: 16, marginTop: 20, marginBottom: 10 },
  freeGrid: { flexDirection: 'row', flexWrap: 'wrap', paddingHorizontal: 12, gap: 8 },
  freeCard: { width: '47%', backgroundColor: '#fff', borderRadius: 14, padding: 14, borderWidth: 0.5, borderColor: 'rgba(27,63,47,0.1)' },
  ...
  premiumSmall: { flex: 1, backgroundColor: '#fff', borderRadius: 12, padding: 12, alignItems: 'center', borderWidth: 0.5, borderColor: 'rgba(27,63,47,0.1)' },
  ...
  lockedDiet: { backgroundColor: '#fff', marginHorizontal: 16, marginBottom: 8, borderRadius: 14, padding: 16, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderWidth: 0.5, borderColor: 'rgba(27,63,47,0.1)', opacity: 0.75 },
  lockedDietTitle: { fontSize: 15, fontWeight: '600', color: Colors.pine, marginBottom: 2 },
  lockedDietSub: { fontSize: 11, color: '#6B7F72' },
  lockIcon: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#ECEFE8', alignItems: 'center', justifyContent: 'center' },
  lockedRow: { flexDirection: 'row', paddingHorizontal: 12, gap: 8, marginBottom: 12 },
  lockedSmall: { flex: 1, backgroundColor: '#fff', borderRadius: 12, padding: 12, alignItems: 'center', borderWidth: 0.5, borderColor: 'rgba(27,63,47,0.1)', opacity: 0.75 },
  lockedSmallIcon: { marginBottom: 4 },
  lockedSmallName: { fontSize: 12, fontWeight: '600', color: Colors.pine, marginBottom: 2 },
  bigActivateCard: { backgroundColor: Colors.pine, marginHorizontal: 16, marginTop: 4, borderRadius: 16, padding: 20 },
